...
from openedx.core.djangoapps.zendesk_proxy import utils
...
class ViewsTestCase(ModuleStoreTestCase):
    ...
    @patch.object(utils, 'create_zendesk_ticket')
    ...
    @patch.object(utils, 'create_zendesk_ticket', return_value=500)
